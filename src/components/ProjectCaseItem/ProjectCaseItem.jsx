...
export default function ProjectCaseItem() {
  const skills = ["Branding",  "Typography", "Adobe Illustrator", "C++", "Phython", "Eclipse"];
  
  return (
    <article className="case">
      <div className="case__title">
        <h2 className="case__title--name">Mauricio's Portfolio</h2>
        <h3>Branding, Web Design and Mini Game Developement</h3>
        <div>
          {skills.map((skill, index) => (
            <p className="case__title--skills " key={index}>
              {skill}
            </p>
          ))}
        </div>
